<template>
  ...
  >
    <div :style="viewBoxStyle">
      ...
      <img
        v-if="ionImage && opticalImageUrl && loadedOpticalImageUrl !== opticalImageUrl"
        :key="opticalImageUrl"
        :src="opticalImageUrl"
    ...
    >
      <p class="image-loader__overlay-text">
        Use {{ messageOS }} to zoom the image
      </p>
    </div>
  </div>
</template>

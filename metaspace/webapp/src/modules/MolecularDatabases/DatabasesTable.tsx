      ...
      <div>
        <header class="flex justify-between items-center py-3">
          <div class="flex items-center">
            <GroupIcon class="sm-colour-icon sm-colour-icon--large mx-3 w-6 h-6" />
            <p class="m-0 ml-2 text-sm leading-5 text-gray-700">
              Databases are only available to members of this group, never to others.
              <br />
              We provide the option to make annotations generated by a database visible to all.
            </p>
          </div>

        ...
        <div class="pro-shell pro-hero__row" style={{ paddingTop: 'clamp(56px, 7vw, 96px)' }}>
          <div class="pro-hero__copy">
            ...
            <p class="pro-lede" style={{ maxWidth: '57ch' }}>
              Differential analysis, spatial segmentation and cross-dataset statistics, downstream analysis built
              directly onto the annotation engine you already trust and use, on data that never enters the public
              database until you say so.
            </p>

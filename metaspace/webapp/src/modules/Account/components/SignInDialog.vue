<template>
  <el-dialog title="Sign in" visible @close="onClose" :lockScroll="false">
    <div class="sign-in">
      <div class="left-side">
        <el-form ref="form" :model="model" :rules="rules">
          <el-form-item prop="email" :validateStatus="isInvalid ? 'error' : undefined">
            <el-input
              v-model="model.email"
              placeholder="Email address"
            />
          </el-form-item>
          <el-form-item prop="password" :validateStatus="isInvalid ? 'error' : undefined">
            <el-input
              type="password"
    ...
    <p><inter-dialog-link dialog="forgotPassword">Forgot password?</inter-dialog-link></p>
    <p>
      New user? <inter-dialog-link dialog="createAccount">Create an account</inter-dialog-link>
    </p>
    <p style="margin-bottom: 0">
      Submitted data previously but never set a password? <a href="#" @click.prevent="togglePreMigrationUserInfo">Click here</a>
    </p>
    <vue-slide-up-down :active="showPreMigrationUserInfo">
      <p style="margin-bottom: 0;">
        ...
        please <inter-dialog-link dialog="createAccount">create an account</inter-dialog-link> using the same email address

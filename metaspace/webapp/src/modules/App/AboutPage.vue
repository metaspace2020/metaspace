<template>
  ...
  >
    <div class="bg-primary overflow-hidden w-full -mt-2 sm-banner-gradient">
      <div class="box-border font-display px-0 py-12 mx-auto my-0 max-w-4xl flex items-center">
        <img
          src="../../assets/METASPACE_logomark.png"
          class="hidden md:block w-72 h-72 -ml-6"
        >
        <div class="text-white box-border pl-12 md:pt-12 h-72">
          <h1 class="m-0">
            <span class="text-4xl leading-12">Welcome to</span>
            <br>
            <svg
          ...
          <p class="text-2xl m-0 leading-7 py-2">

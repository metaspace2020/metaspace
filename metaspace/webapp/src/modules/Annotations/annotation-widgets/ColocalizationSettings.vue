  ...
  <span id="colocalization-settings">
    <el-form label-position="top">
      <el-form-item>
          ...
          <span>
            ...
            <el-popover trigger="hover" placement="top">
              <div style="max-width: 550px">
                <p>
                  The <b>median-thresholded cosine distance</b> algorithm is the best choice for exploring most datasets
                  in METASPACE. It was found to highly reproduce expert rankings of mass spectrometry ion images and
                  performed better than other traditional colocalization measures. <br />
                  Its description and evaluation can be found in:
                  <a href="https://doi.org/10.1093/bioinformatics/btaa085" target="blank"
                    >Ovchinnikova et al. (2020) ColocML</a
                  >.
                </p>
                <p>
                  The <b>cosine distance</b> was previously used as the default colocalization measure. It is still
                  available and can be selected from the list.
                </p>
              </div>
              <template #reference>
        ...
        <el-select v-model="colocalizationAlgo" style="width: 300px" title="Colocalization algorithm">
          <el-option v-for="{ id, name } in colocalizationAlgoOptions" :key="id" :value="id" :label="name" />
        </el-select>
      </el-form-item>
    </el-form>
  </span>
...
export default defineComponent({
  setup() {
    ...
    const colocalizationAlgo = computed({
      get: () =>
        store.getters.settings.annotationView.colocalizationAlgo ||

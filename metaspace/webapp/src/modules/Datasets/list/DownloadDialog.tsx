  ...
  setup(props) {
    return () => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 100" style="width: 32px; height: 50px">
        ...
        <text x="36" y="60" text-length="64" text-anchor="middle" font-size="20px" font-weight="bold" fill="#7191a1">
          {props.ext}
        </text>
      </svg>
    )
            ...
            <p>
              {license.code === 'NO-LICENSE' ? (
                ...
                <p>
                  ...
                  <a href={license.link} rel="noopener noreferrer nofollow" target="_blank">
                    {license.code}
                  </a>{' '}

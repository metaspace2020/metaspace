...
export const updateProjectMutation = gql`
  mutation updateProject($projectId: ID!, $projectDetails: UpdateProjectInput!) {
...
export const requestAccessToProjectMutation = gql`
  mutation requestAccessToProject($projectId: ID!) {
...
export const acceptRequestToJoinProjectMutation = gql`
  mutation acceptRequestToJoinProject($projectId: ID!, $userId: ID!) {
...
export const inviteUserToProjectMutation = gql`
  mutation inviteUserToProject($projectId: ID!, $email: String!) {
...
export const acceptProjectInvitationMutation = gql`
  mutation acceptProjectInvitation($projectId: ID!) {
...
export const leaveProjectMutation = gql`
  mutation leaveProject($projectId: ID!) {
    leaveProject(projectId: $projectId)
  }
`

export const updateUserProjectMutation = gql`
  mutation updateUserProject($projectId: ID!, $userId: ID!, $update: UpdateUserProjectInput!) {
    updateUserProject(projectId: $projectId, userId: $userId, update: $update)
  }
`

export const importDatasetsIntoProjectMutation = gql`
  mutation ($projectId: ID!, $datasetIds: [ID!], $removedDatasetIds: [ID!]) {
    importDatasetsIntoProject(projectId: $projectId, datasetIds: $datasetIds, removedDatasetIds: $removedDatasetIds)
  }
`

export const createReviewLinkMutation = gql`
  mutation createReviewLinkMutation($projectId: ID!) {
...
export const deleteReviewLinkMutation = gql`
  mutation deleteReviewLinkMutation($projectId: ID!) {
    deleteReviewLink(projectId: $projectId)
  }
`

export const updateProjectDOIMutation = gql`
  mutation updateProjectDOIMutation($projectId: ID!, $link: String!) {
    addProjectExternalLink(projectId: $projectId, provider: "DOI", link: $link, replaceExisting: true) {
      id
      externalLinks {
        provider
        link
...
export const removeProjectDOIMutation = gql`
  mutation removeProjectDOIMutation($projectId: ID!) {
    removeProjectExternalLink(projectId: $projectId, provider: "DOI") {
      id
      externalLinks {
        provider
        link
...
export const publishProjectMutation = gql`
  mutation publishProjectMutation($projectId: ID!) {
...
export const editProjectQuery = gql`
  query EditProjectQuery($projectId: ID!) {
...
const projectsListItemFragment = gql`
...
export const ViewProjectFragment = gql`
  fragment ViewProjectFragment on Project {
    id
    name
    urlSlug
    currentUserRole

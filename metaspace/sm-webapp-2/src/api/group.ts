...
export const createGroupMutation = gql`
  mutation createGroup($groupDetails: CreateGroupInput!) {
...
export const updateGroupMutation = gql`
  mutation updateGroup($groupId: ID!, $groupDetails: UpdateGroupInput!) {
...
export const requestAccessToGroupMutation = gql`
  mutation requestAccessToGroup($groupId: ID!) {
...
export const acceptRequestToJoinGroupMutation = gql`
  mutation acceptRequestToJoinGroup($groupId: ID!, $userId: ID!) {
...
export const inviteUserToGroupMutation = gql`
  mutation inviteUserToGroup($groupId: ID!, $email: String!) {
...
export const updateUserGroupMutation = gql`
  mutation updateUserGroup($groupId: ID!, $userId: ID!, $update: UpdateUserGroupInput!) {
    updateUserGroup(groupId: $groupId, userId: $userId, update: $update)
  }
`

export const importDatasetsIntoGroupMutation = gql`
  mutation ($groupId: ID!, $datasetIds: [ID!]!) {
    importDatasetsIntoGroup(groupId: $groupId, datasetIds: $datasetIds)
  }
`

export const editGroupQuery = gql`
  query EditGroupProfileQuery($groupId: ID!) {
...
export const ViewGroupFragment = gql`
  fragment ViewGroupFragment on Group {
    id
    name
    shortName
    urlSlug
...
export const getGroupDatabasesQuery = gql`
  query GetGroupDatabasesQuery($groupId: ID!) {
    group(groupId: $groupId) {
      id
...
export const getUserGroupsQuery = gql`
  query GetUserGroupsQuery($query: String!, $useRole: Boolean) {
...
export const countGroupsQuery = gql`
  query countGroups {
    countGroups
  }
`

export const countPublicationsQuery = gql`
  query countPublications {
    countPublications
  }
`

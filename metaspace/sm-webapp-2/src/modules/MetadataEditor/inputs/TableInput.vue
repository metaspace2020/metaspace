<template>
  <div class="table-input">
    ...
    >
      <el-table-column v-for="(field, fieldName) in fields" :key="fieldName" :label="field.title" :prop="fieldName">
    ...
    <div>
      <el-button class="table-btn" :disabled="selectedRow == null" @click.prevent="onRemoveRow"> Delete row </el-button>
      <el-button class="table-btn" @click.prevent="onAddRow"> Add row </el-button>
    </div>
  </div>
</template>
...
import { ElTable, ElButton, ElTableColumn } from '../../../lib/element-plus'

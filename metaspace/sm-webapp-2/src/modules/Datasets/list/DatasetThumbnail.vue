<template>
  <router-link v-if="editable" :to="opticalImageAlignmentHref">
    <div class="thumb thumb__editable" :class="showEmpty && 'thumb__empty'" :title="title">
      <img
      ...
      />
      <img v-if="showEmpty" class="thumb--img" src="../../../assets/no_opt_image.png" alt="Add optical image" />
  ...
  <div v-else class="thumb" :class="showEmpty && 'thumb__empty'">
    <img
      v-if="hasOpticalImage"
      class="thumb--img"
      :style="imageStyle"
    ...
    <img
      ...
      @error="ionLoadError = true"
    />
    <img v-if="showEmpty" class="thumb--img" src="../../../assets/no_opt_image.png" alt="No optical image" />
  </div>
</template>

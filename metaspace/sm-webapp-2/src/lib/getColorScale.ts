...
const scales: Record<string, ColorScale> = {
  Viridis: {
    domain: [
      0, 0.06274509803921569, 0.12549019607843137, 0.18823529411764706, 0.25098039215686274, 0.3137254901960784,
      0.3764705882352941, 0.4392156862745098, 0.5019607843137255, 0.5647058823529412, 0.6274509803921569,
      0.6901960784313725, 0.7529411764705882, 0.8156862745098039, 0.8784313725490196, 0.9411764705882353, 1,
    ],
    range: [
      '#440154',
      '#48186a',
  ...
  Cividis: {
    domain: [
      0, 0.058824, 0.117647, 0.176471, 0.235294, 0.294118, 0.352941, 0.411765, 0.470588, 0.529412, 0.588235, 0.647059,
      0.705882, 0.764706, 0.823529, 0.882353, 0.941176, 1,
    ],
    range: [
      'rgb(0,32,76)',
      'rgb(0,42,102)',
  ...
  Hot: {
    domain: [0, 0.3, 0.6, 1],
    range: ['rgb(0,0,0)', 'rgb(230,0,0)', 'rgb(255,210,0)', 'rgb(255,255,255)'],
  },
  YlGnBu: {
  ...
  Portland: {
    ...
    range: ['rgb(12,51,131)', 'rgb(10,136,186)', 'rgb(242,211,56)', 'rgb(242,143,56)', 'rgb(217,30,30)'],
  },
  Greys: {
    domain: [0, 1],
...
function getChannelScale(channel: string): ColorScale {
  return {
    domain: [0, 1],
    range: ['rgb(0,0,0)', channels[channel]],
  }
}

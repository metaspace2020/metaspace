"""
Step 4: Load the results, train and evaluate the model and save it to disk or S3.
...
#%% Load the data from a "flat format" parquet file (generated by run_retrieve_data.py)
...
OUTPUT_PATH = Path('../scoring-models') / MODEL_NAME

model_path, version = save_catboost_scoring_model(final_model, OUTPUT_PATH)

#%% Save model to S3 (Optional)

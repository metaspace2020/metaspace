...
createuser sm
createdb sm
wget https://raw.githubusercontent.com/SpatialMetabolomics/SM_distributed/master/scripts/create_schema.sql
...
conda create -y -q -n sm_distributed -c https://conda.binstar.org/menpo -c salford_systems matplotlib-nogui scipy numba==0.22.1 pytest mock Fabric lxml psycopg2 opencv3 >conda.stdout

...
describe('GraphQL integration: Dataset type', () => {
  ...
  it('allDatasets with name filter should return correct config and metadata', (done) => {
    ...
    const expectedConfig = {"image_generation":{"q":99,"do_preprocessing":false,"nlevels":30,"ppm":3},"isotope_generation":{"adducts":["+H","+K","+Na"],"charge":{"polarity":"+","n_charges":1},"isocalc_sigma":0.000619,"isocalc_pts_per_mz":8078},"databases":[{"name":"HMDB","version":"2016"}]},

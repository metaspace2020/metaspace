...
export class AddSegmentation1773248786936 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "public"."image_segmentation_job" ("id" SERIAL NOT NULL, "ds_id" text NOT NULL, "status" text NOT NULL, "error" text, "created_at" TIMESTAMP NOT NULL DEFAULT NOW(), "updated_at" TIMESTAMP NOT NULL DEFAULT NOW(), CONSTRAINT "PK_02b755530fe45b2070cf66f93b7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "public"."segmentation" ("id" uuid NOT NULL DEFAULT uuid_generate_v1mc(), "dataset_id" text NOT NULL, "job_id" integer, "segment_index" integer NOT NULL, "algorithm" text NOT NULL, "status" text NOT NULL, "error" text, "created_at" TIMESTAMP NOT NULL DEFAULT NOW(), "updated_at" TIMESTAMP NOT NULL DEFAULT NOW(), CONSTRAINT "PK_4bc2a01449d339b58b557792a86" PRIMARY KEY ("id"))`);

...
export class MolecularDB1579706058929 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "public"."molecule" ("id" SERIAL NOT NULL, "mol_id" text NOT NULL, "mol_name" text NOT NULL, "formula" text NOT NULL, "moldb_id" integer, CONSTRAINT "PK_d9e3f72bdba412e5cbeea2a1915" PRIMARY KEY ("id"))`);

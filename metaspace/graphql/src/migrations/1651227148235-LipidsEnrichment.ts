...
export class LipidsEnrichment1651227148235 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "public"."enrichment_bootstrap" ("id" SERIAL NOT NULL PRIMARY KEY, "scenario" integer NOT NULL, "formula_adduct" text NOT NULL, "fdr" numeric(2,2) NOT NULL, "dataset_id" text REFERENCES "public"."dataset"("id") ON DELETE CASCADE ON UPDATE NO ACTION, "enrichment_db_molecule_mapping_id" integer REFERENCES "public"."enrichment_db_molecule_mapping"("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);

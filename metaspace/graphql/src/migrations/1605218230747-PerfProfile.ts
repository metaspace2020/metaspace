...
export class PerfProfile1605218230747 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "public"."perf_profile_entry" ("id" SERIAL NOT NULL, "profile_id" integer NOT NULL, "sequence" integer NOT NULL, "start" TIMESTAMP NOT NULL, "finish" TIMESTAMP NOT NULL, "name" text NOT NULL, "extra_data" json, "stats_id" integer, CONSTRAINT "PK_729ef8c877e7facd61d75e754e9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "public"."perf_profile_entry" ADD CONSTRAINT "FK_1163dde88aabf47524bcfff502d" FOREIGN KEY ("stats_id") REFERENCES "public"."perf_profile"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."perf_profile_entry" DROP CONSTRAINT "FK_1163dde88aabf47524bcfff502d"`);

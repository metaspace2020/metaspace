...
export class ReviewLink1570724854411 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "graphql"."dataset" ADD "publication_status" text NOT NULL DEFAULT 'UNPUBLISHED'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "graphql"."dataset" DROP COLUMN "publication_status"`);
